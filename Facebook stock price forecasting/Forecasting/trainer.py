...
def train_test_perfornace(reg, grid, finance, train_X_sc, train_y_sc, test_X_sc, test_y_sc, 
    ...
    #print('fb_t_1_tr', fb_t_1_tr.shape)
    ...
    #print('yhat_return_sc_tr',yhat_return_sc_tr.shape)
    yhat_return_tr =  y_sc.inverse_transform(yhat_return_sc_tr.reshape(-1,1))
    #print('yhat_return_tr',yhat_return_sc_tr.shape)
    yhat_stock_tr = (yhat_return_tr.flatten() + 1) * fb_t_1_tr
    ...
    yhat_stock = (yhat_return.flatten() + 1) * fb_t_1
